// src/handlers/FileReadHandler.h
#pragma once
...
public:
  FileReadHandler(Napi::Env env, Napi::Promise::Deferred deferred,
  ...
  virtual void HandleResponse(XrdCl::XRootDStatus *status,
    ...
    tsfn_.BlockingCall(
        [this, statusStr = status->ToString(), isOk = status->IsOK(),
         bytesRead](Napi::Env env, Napi::Function /*jsCallback*/) {
          if (isOk) {
            // 核心：零拷贝包装！
